...
import Faqconatct from "./Faqconatct";
    ...
    <>
      <div className="Investfaq-parent">
        <div className="Investfaq-subparent">
          <HomeNavbar />
          <div className="faq-subparent">
            <h2>
              FAQ'S<span> (FREQUENTLY ASKED QUESTIONS) </span>
            </h2>
          </div>
        </div>
            ...
            {itemsToShow.map((item, index) => (
              <div key={index} className="col-md-12 p-0">
                <div className="accordion-item">
                  ...
                  {openIndex === index && (
                    <div className="accordion-item-desc">{item.answer}</div>
                  )}
                </div>
              </div>
            ))}
