          ...
          <div className="row align-items-end">
            ...
            <div className="col-md-4">
              <div className="TabsSection-right">
                <img
                  className="particular-project-Logo"
                  src={propertyData?.projectMainLogo}
                  alt=""
                />
...
export default OngoingTabsSection;
