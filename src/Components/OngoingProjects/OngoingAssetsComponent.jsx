...
const OngoingAssetsComponent = () => {
    ...
    useEffect(() => {
        ...
        if (urlParams.has('download') && urlParams.get('download') === 'true') {
            ...
            let filePath = '';
            if (documentType === 'modal1') filePath = '/brouchers/G_Aranya_E-Brochure.pdf';
            if (documentType === 'modal2') filePath = '/master-plans/G_Aranya_Master_plan.pdf';
            if (documentType === 'modal3') filePath = '/floor-plans/G_Aranya_Floor_Plans_plan.pdf';
